/* Generated automatically by the program 'build/genpreds'
   from the machine description file '/home/badr/Embedded_Lunix/Cross-ToolChain/crosstool-ng/bin/.build/aarch64-rpi3-linux-gnu/src/gcc/gcc/config/aarch64/aarch64.md'.  */
